...
export const en: Dictionary = {
  chrome: {
    ...
    clusterSwitcher: {
      ...
      removed: (name: string) => `removed context ${name}`,
      removeFailed: 'Remove failed',
      removeContext: (name: string) => `remove ${name}`,
    },
    aiFab: {
  ...
  onboarding: {
    ...
    import: {
      ...
      paste: 'Or paste YAML',
      pasteHide: 'Hide paste area',
      pasteUnsupported: 'Paste mode is only available in the browser shell.',
      pastePlaceholder: 'apiVersion: v1\nclusters:\n- cluster:\n    server: …',
      parsing: 'Parsing…',
      parse: 'Parse & preview',
      previewOk: 'Validation passed — ready to import',
      previewBad: 'Validation failed: fix the errors above and parse again',
      clusters: 'Clusters',
      users: 'Users',
      contexts: 'Contexts',
      importPasted: 'Import',
  ...
  helm: {
    ...
    local: {
      ...
      render: {
        ...
        button: 'Render',
        empty: 'Press Render to preview the chart’s rendered manifests — nothing is applied to the cluster',
        stats: 'Resource stats',
      },
      diff: {
        title: 'Compare versions',
        pickA: 'Select version A…',
        pickB: 'Select version B…',
        identical: 'The two versions render identical files',
      },
      tools: {
        title: 'Toolbox',
        lint: 'Lint',
        ...
        depsUpdate: 'Update',
        run: 'Run',
        onlyTgz: 'Packaged charts only',
        onlyDir: 'Directory charts only',
        packaged: 'Packaged to library',
      },
    },
    profiles: {
      ...
      confirmDelete: (name) => `Delete profile "${name}"?`,
      upgradeTitle: 'Upgrade existing release',
